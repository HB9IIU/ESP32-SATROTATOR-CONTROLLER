...
struct Satellite {
  ...
  // Define the satellite array
  Satellite satellites[] = {
    {"ISS", 25544},             // International Space Station
    {"NOAA 15", 25338},         // NOAA 15 (Polar Orbiting Weather Satellite)
    {"NOAA 18", 28654},         // NOAA 18 (Polar Orbiting Weather Satellite)
    {"NOAA 19", 33591},         // NOAA 19 (Polar Orbiting Weather Satellite)
    {"METOP-A", 29155},         // METOP-A (EUMETSAT Weather Satellite)
    {"METOP-B", 38771},         // METOP-B (EUMETSAT Weather Satellite)
    {"METOP-C", 43689},         // METOP-C (EUMETSAT Weather Satellite)
    {"Fengyun 3D", 40940},      // Fengyun 3D (Chinese Weather Satellite)
    {"Himawari 8", 43014},      // Himawari 8 (Geostationary Weather Satellite)
    {"GOES 16", 41866},         // GOES 16 (Geostationary Weather Satellite)
    {"GOES 17", 43226},         // GOES 17 (Geostationary Weather Satellite)
    {"Suomi NPP", 37849},       // Suomi NPP (Weather and Climate Satellite)
    {"AO-91", 43017},           // AO-91 (AMSAT Fox-1B, LEO HAM Satellite)
    {"AO-92", 43137},           // AO-92 (AMSAT Fox-1D, LEO HAM Satellite)
    {"OSCAR 7", 7530},          // OSCAR 7 (AO-7, HAM Satellite)
    {"CAS-4A", 43770},          // CAS-4A (LeoSat-2, HAM Satellite)
    {"CAS-4B", 43771},          // CAS-4B (LeoSat-3, HAM Satellite)
    {"FUNCUBE-1", 39444},       // FUNCUBE-1 (AO-73, HAM Satellite)
    {"QO-100", 44832},          // QO-100 (Es'hail-2, GEO HAM Satellite)
    {"SO-50", 27607},           // SO-50 (SaudiSat-1C, HAM Satellite)
    {"LilacSat-2", 40908},      // LilacSat-2 (CAS-3H, HAM Satellite)
    {"FO-29", 24278},           // FO-29 (JAS-2, Fuji OSCAR 29)
    {"EO-79", 39445},           // EO-79 (Nayif-1, HAM Satellite)
    {"AO-85", 41168},           // AO-85 (AMSAT Fox-1A, LEO HAM Satellite)
    {"CAS-6", 43678},           // CAS-6 (XW-4, HAM Satellite)
    {"Diwata-2", 43743},        // Diwata-2 (Philippine Microsatellite, HAM Radio)
    {"HAMSAT", 28650},          // HAMSAT (VO-52, ISRO Satellite)
    {"Tevel-1", 43786},         // Tevel-1 (Israeli HAM Satellite)
    {"Tevel-2", 43803},         // Tevel-2 (Israeli HAM Satellite)
    {"Hubble", 20580},          // Hubble Space Telescope (HST)
    {"Sentinel-6", 46984}       // Sentinel-6 Michael Freilich (Earth Observation)
  };
